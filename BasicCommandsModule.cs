...
public class BasicCommandsModule : BaseCommandModule
{
    ...
    public async Task Mount(CommandContext ctx, params string[] args)
    {
        ...
        string search = args.Aggregate<string>((a, b) => a + " " + b);
        ...
        foreach (var mount in mounts)
        {
            ...
            string stringToAdd = $"{(emoji != null ? emoji : string.Empty)} **{mount.Name}**\n{mount.Description}\n\n";
    ...
    public async Task Mounts(CommandContext ctx)
    {
        ...
        Dictionary<MountType, List<Mount>> mountByType = new Dictionary<MountType, List<Mount>>();
